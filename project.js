...
const spin = () =>{
    const symbols = []; // array is collection of multiple elements
    for(const [symbol, count] of Object.entries(SYMBOLS_COUNT)){
        for(let i=0; i<count; i++){
            symbols.push(symbol); //push is method to insert into the array
        }
    }
...
const game = () => {
    let balance  = deposit();
   while(true){
        console.log("you have a balance amount of $ " + balance);
